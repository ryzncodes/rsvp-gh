...
const TRANSLATIONS = {
    ...
    'en': {
        ...
        'invitation-subtext': 'cordially invite you to the wedding reception of their beloved daughter',
        'couple-names': 'Nur Dini Zakaria & Muhammad Faiz Kasman',
        'bride-name': 'Nur Dini Zakaria',
        ...
        'groom-name': 'Muhammad Faiz Kasman',
        'and': '&',
    ...
    'bm': {
        ...
        'parents-names-header': 'Zakaria Md Husain & Noraiyu binti Buang',
        'invitation-subtext': 'dengan penuh rasa hormat menjemput anda ke majlis perkahwinan anak kesayangan mereka',
        'couple-names': 'Nur Dini Zakaria & Muhammad Faiz Kasman',
        'bride-name': 'Nur Dini Zakaria',
        'location-venue': 'Iris Hall Bangi',
        'location-address': '22A, Jalan P/1A, Suntrack Industrial Hub Seksyen 13, Bandar Baru Bangi',
        ...
        'phone': 'Telefon',
        'email': 'Emel',
        'email-optional': '(Pilihan)',
        'will-attend': 'Adakah anda akan hadir?',
        'yes': 'Ya',
        'no': 'Tidak',
        'dietary': 'Sekatan Pemakanan',
        'dietary-optional': '(Pilihan)',
        'dietary-placeholder': 'Sila senaraikan sebarang sekatan pemakanan atau alahan',
        'wishes': 'Ucapan & Doa',
        'wishes-optional': '(Pilihan)',
